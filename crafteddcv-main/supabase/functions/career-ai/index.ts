...
function buildPrompts(
  ...
  options: { tone?: string; company?: string; role?: string; targetJobTitle?: string }
...
{
  "questions": [
    { "question": "the interview question", "category": "Behavioral" | "Technical" | "Role-specific" | "Screening", "hint": "1-2 sentence personalized talking point referencing the candidate's real experience" },
...
Produce the interview prep JSON now.`,
    ...
    case "suggest_skills": {
      return {
        expectJson: true,
        systemPrompt: `You are an expert career advisor and ATS specialist. Suggest skills a candidate should add to their CV: skills they plausibly have based on their experience/education/projects but haven't listed, plus high-value keywords for their target role.
